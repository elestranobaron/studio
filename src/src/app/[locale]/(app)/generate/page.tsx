...
export default function GenerateWodPage() {
    ...
    const handleGenerate = async () => {
        ...
        try {
            if (!firebaseApp) {
                console.error("DEBUG ERR - Firebase app not initialized");
            ...
            console.log("DEBUG 5 - Response received from server");
            const wodData = response.data as any;
            
            if (!wodData || !wodData.name) {
                console.error("DEBUG ERR - Invalid data format", wodData);
                throw new Error("Invalid data format received from AI.");
            }

            if (!firestore) throw new Error("Firestore not available");

            console.log("DEBUG 6 - Processing WOD data into state");
            ...
            console.log("DEBUG 7 - WOD displayed successfully");
            ...
            console.log("DEBUG 8 - Process finished");
            setIsLoading(false);
