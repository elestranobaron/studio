...
export default function GenericTimerPage() {
    ...
    const timerConfigs: Record<string, { name: WodType, title: string, description: string }> = {
        'for-time': { name: 'For Time', title: t('forTime.title'), description: t('forTime.description') },
        'amrap': { name: 'AMRAP', title: t('amrap.title'), description: t('amrap.description') },
        'emom': { name: 'EMOM', title: t('emom.title'), description: t('emom.description') },
        'tabata': { name: 'Tabata', title: t('tabata.title'), description: t('tabata.description') },
    };
