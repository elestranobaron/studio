      ...
      return (
         <div className="flex flex-col items-center justify-center h-screen bg-background p-4">
            <Card className="max-w-md text-center">
                <CardHeader>
                    <CardTitle>{t('accessRestricted.title')}</CardTitle>
                    <CardDescription>
             ...
             <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
                <SheetTrigger asChild>
                    <Button variant="outline" className="bg-background/50 backdrop-blur-sm">
                        <BookOpen className="mr-2 h-4 w-4" /> {t('viewWod')}
                    </Button>
                </SheetTrigger>
                    ...
                    <div className="py-4 space-y-2">
                        <Button onClick={handleWodSelect} variant="ghost" className="w-full justify-start h-auto py-2 px-2 mb-2">
                            <div className="text-left">
                                <h4 className="font-headline text-lg text-foreground">{t('fullWodLabel', { wodName: wod.name })}</h4>
